          ...
          quizObj = {
            ...
            function markQuiz(){
                ...
                for(var i = 0; i < userAns.length; i++){
                    if(userAns[i]==DataService.correctAnswers[i]){
                        DataService.quizQuestions[i].correct = true;
                 quizObj.numCorrect= redingo;
                       redingo++;
				...
				if(quizObj.numCorrect>DataService.quizQuestions.length){quizObj.numCorrect=DataService.quizQuestions.length}
            }
